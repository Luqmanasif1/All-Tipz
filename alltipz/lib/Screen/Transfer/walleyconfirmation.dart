import '/Screen/Transfer/transferSucess.dart';
...
class WallyConformation extends StatefulWidget {
  const WallyConformation({Key? key}) : super(key: key);

  @override
  _WallyConformationState createState() => _WallyConformationState();
}

class _WallyConformationState extends State<WallyConformation> {
  @override
            ...
            GestureDetector(
              onTap: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => TransferSuccess()),
                );
              },
              child: Container(
                width: SizeConfig.screenWidth,
