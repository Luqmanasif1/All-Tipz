...
class SizeConfig {
  ...
  static double thirtytwoPercentWidth = 32;
  static double thirtyonePercentWidth = 31;
  static double thirtythreePercentWidth = 33;
  ...
  static double fortyPercentWidth = 40;
  static double fortytwoPercentWidth = 42;
  static double fortyfivePercentWidth = 45;
  static double fortysixPercentWidth = 46;
  static double fortysevenPercentWidth = 47;
  ...
  void init(BuildContext context) {
    ...
    fortyfivePercentWidth = blockSizeHorizontal * 45;
    fortysixPercentWidth = blockSizeHorizontal * 46;
    fortysevenPercentWidth = blockSizeHorizontal * 47;
    thirtytwoPercentWidth = blockSizeHorizontal * 32;
    thirtyonePercentWidth = blockSizeHorizontal * 31;
    thirtythreePercentWidth = blockSizeHorizontal * 33;
    fortyPercentWidth = blockSizeHorizontal * 40;
    fortytwoPercentWidth = blockSizeHorizontal * 42;
